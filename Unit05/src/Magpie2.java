...
public class Magpie2
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement, "Mauro", 0) >= 0)
		{
			response = "Oh I love Tony Mauro!";
		}
		else if (findKeyword(statement, "sicko mode", 0) >= 0)
		{
			response = "That song is trash. They should have played Sweet Victory";
		}
		else if (findKeyword(statement, "lacrosse", 0) >= 0)
		{
			response = "Lacrosse, you mean the best sport?";
		}
		else if (findKeyword(statement, "smash", 0) >= 0)
		{
			response = "I main Ike";
		}
